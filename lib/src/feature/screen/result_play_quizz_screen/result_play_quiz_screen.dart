          ...
          child: Column(
            ...
            children: [
              ...
              MainButton(
                ...
                onPressed: () {
                  context.router.push(
                      ReviewQuizPlayedRoute(historyId: model.historyId ?? 0));
                },
              ),
              const SizedBox(
                height: 16.0,
              ...
              MainButton(
                ...
                onPressed: () {
                  context.router.popUntil(
                    (route) =>
                        route.settings.name == QuestionSetDetailRoute.name ||
                        route.settings.name == QuestionSetInClassRoute.name,
                  );
                },
              ),
            ],
